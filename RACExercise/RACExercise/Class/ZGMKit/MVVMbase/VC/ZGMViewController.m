...
#import "ZGMViewController.h"

@interface ZGMViewController ()
@property (nonatomic, assign) UIStatusBarStyle statusBarStyle;
@property (nonatomic, assign) BOOL statusBarHidden;
@property (nonatomic, assign) BOOL changeStatusBarAnimated;
@end

@implementation ZGMViewController
...
- (void)viewDidLoad {
    ...
    [self zgm_removeNavgationBarLine];
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    ...
    ZGMViewController *viewController = [super allocWithZone:zone];
    ...
    [[viewController rac_signalForSelector:@selector(viewDidLoad)] subscribeNext:^(id x) {
        ...
        [viewController zgm_addSubviews];
        [viewController zgm_bindViewModel];
    }];
    
    [[viewController rac_signalForSelector:@selector(viewWillAppear:)] subscribeNext:^(id x) {
        
        @strongify(viewController)
        [viewController zgm_layoutNavigation];
        [viewController zgm_getNewData];
    }];
    
    return viewController;
}

- (instancetype)initWithViewModel:(id<ZGMViewControllerProtocol>)viewModel {
 ...
 *  去除nav 上的line
 */
- (void)zgm_removeNavgationBarLine {
